...
lbl_alloc_info_tech = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_health = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_consumer_discretionary = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_communications = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_financials = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_industrials = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_consumer_staples = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_utilities = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_materials = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_real_estate = Label(master=frm_editors,width=10,anchor='w')
lbl_alloc_energy = Label(master=frm_editors,width=10,anchor='w')
...
for i in range(11):
    allocation_labels[i].grid(row=i,column=4,sticky="w",padx=15)
